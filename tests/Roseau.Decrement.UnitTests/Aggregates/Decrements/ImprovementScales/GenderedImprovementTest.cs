...
[TestClass]
public class GenderedImprovementTest
{
	#region Fields
	...
	private static GenderedImprovement GenderedImprovement { get; } = new(ImprovementTableMocked.Object, AdjustmentMocked.Object);
