...
{
	static IImprovement<TIndividual> Default => ImprovementDefault<TIndividual>.Default;
	int FirstYear { get; }
	...
	int GetHashCode(TIndividual individual, int tableBaseYear, in DateOnly decrementDate);
